...
const GoalCard = ({ title, progress, startDate, endDate, onAddApplication }) => {
  const data = {
  ...
  return (
    <div className='flex flex-col items-center border border-gray-200 rounded-lg p-2 md:p-4 w-full max-w-sm'>
      <h2 className='font-workSans italic text-lg font-semibold mb-2 text-left w-full flex justify-between items-center'>
        ...
        <div className='md:w-8 md:h-8 bg-primary-500 flex items-center justify-center rounded-md ml-2 cursor-pointer' onClick={onAddApplication}>
      ...
      <div className='flex items-center justify-between w-full mt-2'>
        ...
        <div className=''>
          ...
          <div className='grid grid-cols-2 flex-wrap gap-1'>
            <button className='bg-orange-500  w-full text-white py-2 rounded text-sm whitespace-nowrap'>26 de mayo - 02 de junio, 2024 </button>
            <button className='bg-primary-500 w-full text-white  py-2 rounded text-sm whitespace-nowrap'>19 de mayo - 26 de mayo, 2024 </button>
            <button className='bg-primary-600 w-full text-white  py-2 rounded text-sm whitespace-nowrap'>02 de junio - 09 de junio, 2024 </button>
            <button className='bg-blue-500 w-full text-white py-2 rounded text-sm whitespace-nowrap'>09 de junio - 16 de junio, 2024 </button>
          </div>
        </div>
